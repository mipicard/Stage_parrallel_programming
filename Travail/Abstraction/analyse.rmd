...
dataGPU<-data.frame(read.csv2(file="Resultat_GPU.csv",sep=',',dec='.'))
...
statGPU<-ddply(dataGPU,c("Algo", "TailleMat"),summarise,meanTC=mean(TempsCalc))
...
q <- ggplot(statGPU,aes(x=TailleMat, y=meanTC, colour=Algo, shape=Algo))
